...
public abstract class GameState
{
	...
	protected static xyz.digitalcookies.objective.scene.Stopwatch clock;
	...
	public GameState()
	{
		clock = new xyz.digitalcookies.objective.scene.Stopwatch();
	 ...
	 */
	public static synchronized xyz.digitalcookies.objective.scene.Stopwatch getClock()
	{
		return clock;
	}
